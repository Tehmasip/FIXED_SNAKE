...
public class SnakeMovementMultiplayer : MonoBehaviour, IPunObservable {
   ...
   #region Main Variables
    ...
    private void Awake() {
        ...
        snakesKilledText = GameObject.FindGameObjectWithTag("Snake Text").GetComponent<Text>();
        tokenText = GameObject.FindGameObjectWithTag("Tokens Text").GetComponent<Text>();
       // CF2Controls = GameObject.FindGameObjectWithTag("CF2Cavnas");
            return;
        }
